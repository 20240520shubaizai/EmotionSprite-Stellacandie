...
class SummaryMagicModule final:public FeatureModule
{
    Q_OBJECT
public:
    SummaryMagicModule(DataRepository *storage,AiService *ai,QObject *parent=nullptr);
...
private:void refreshHistory();QString formatResult(const QJsonObject&o)const;
    DataRepository*m_storage=nullptr;AiService*m_ai=nullptr;bool m_enabled=true,m_busy=false;QString m_sourceName,m_sourceInfo,m_inputText,m_resultText,m_status,m_mode;QList<SummaryRecord>m_history;QTimer m_phraseTimer;int m_phraseIndex=0;
};
